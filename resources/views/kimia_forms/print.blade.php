        ...
        @foreach ($tables as $table)
            <div class="mb-4">
                ...
                <table class="table table-bordered table-sm"
                    style="width: 100%; max-width: calc(100% - 40px); margin: 0 auto; page-break-inside: avoid; table-layout: fixed; word-wrap: break-word; font-size: 11px; border-collapse: collapse;">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="{{ $table->columns->count() }}" class="text-center">Tidak ada data</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
