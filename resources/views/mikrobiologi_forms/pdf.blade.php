...
<body>
    <div class="header">
        <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 15px;">
            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('assets/img/logo_futami.png'))) }}"
                alt="Logo Futami" style="height: 60px; margin-right: 20px;">
    ...
    <div class="form-info">
        <div>
            <strong>Tanggal Inokulasi:</strong>
            {{ \Carbon\Carbon::parse($mikrobiologi_form->tgl_inokulasi)->format('d/m/Y') }}
        </div>
        <div>
